...
-------------------------------------------------------------------------------------------------------------
 ...
 - Making your project open source is also allowed.
 - For open source projects: if you choose to credit, please include a note that says some or all assets are made by Kanpelle together with the licensing terms.

 ----------

 - Credit is appreciated but not required : (Kanpelle) 
