...
# Wave Configuration (30 enemies per wave)
var wave_configs = [
	{ "count": 30, "enemy_scene": preload("res://Enemies/bottle_trash.tscn") },      # Wave 1
	{ "count": 30, "enemy_scene": preload("res://Enemies/trashbag_trash.tscn") },   # Wave 2
	{ "count": 30, "enemy_scene": preload("res://Enemies/trash_1.tscn") },          # Wave 3
	{ "count": 30, "enemy_scene": preload("res://Enemies/trashbag_trash.tscn") }    # Wave 4
]
...
# =====================================================
func _ready() -> void:
	print("LEVEL STARTED: Area 2-2 (Level ", level_id, ")")
...
func _find_all_paths() -> void:
	...
	print("Found ", all_paths.size(), " paths (L1, L2, R1, R2)")
...
func start_next_wave() -> void:
	...
	print("🚀 Starting Wave ", current_wave, "/", total_waves, " - 30 enemies")
...
func spawn_wave(count: int, enemy_scene: PackedScene) -> void:
	for i in range(count):
		await get_tree().create_timer(0.5).timeout     # Faster spawn rate for bigger waves
...
func check_win_condition() -> void:
	...
	if enemies_alive <= 0 and current_wave >= total_waves:
		print("🎉 LEVEL COMPLETE! Area 2-2 Cleared!")
		show_level_complete()
