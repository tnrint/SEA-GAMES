...
var wave_configs = [
	{ "count": 55, "enemy_scene": preload("res://Enemies/bottle_trash.tscn") },      # Wave 1
	{ "count": 55, "enemy_scene": preload("res://Enemies/trashbag_trash.tscn") },   # Wave 2
	{ "count": 55, "enemy_scene": preload("res://Enemies/trash_1.tscn") },          # Wave 3
	{ "count": 55, "enemy_scene": preload("res://Enemies/trashbag_trash.tscn") }    # Wave 4 - Final
]
...
func spawn_wave(count: int, enemy_scene: PackedScene) -> void:
	for i in range(count):
		await get_tree().create_timer(0.38).timeout     # Fast spawn for large wave
